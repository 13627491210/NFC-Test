...
public class RealsunHttp {
    ...
    private static <T extends Request.Builder> T assembleHeader(T builder, DbDownloadParm versionParams) {
    ...
    public static Request.Builder get(DbDownloadParm versionParams) {
    ...
    public static Request.Builder post(DbDownloadParm versionParams) {
    ...
    public static Request.Builder postJson(DbDownloadParm versionParams) {
    ...
    private static FormBody getRequestParams(DbDownloadParm versionParams) {
